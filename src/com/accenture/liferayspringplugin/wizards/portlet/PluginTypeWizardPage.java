...
public class PluginTypeWizardPage extends WizardPage {
	...
	private SpringPortletMavenWizardPage mvnPage;
	 ...
	 * @param pageName
	 */
	public PluginTypeWizardPage(SpringPortletWizard springPortletWizard, SpringPortletAntWizardPage antPage, SpringPortletMavenWizardPage mvnPage) {
		super(WIZARD_PAGE);
	...
	public IWizardPage getNextPage() {
		...
		if(isAntPlugin) {
			return springPortletWizard.getNextPage(nextPage);
		}
		return nextPage;
	}
}